...
const TONES = {
  ...
  typo: 'แก้เฉพาะตัวสะกดผิด คำผิด และเครื่องหมายวรรคตอนที่ผิดชัดเจนเท่านั้น — ห้ามเปลี่ยนคำศัพท์ที่สะกดถูกอยู่แล้ว ห้ามตัด/เพิ่ม/สลับคำ ห้ามปรับสำนวน น้ำเสียง หรือโครงประโยค คงทุกอย่างที่ไม่ผิดไว้เป๊ะทุกตัวอักษร',
}
