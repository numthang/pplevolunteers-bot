...
export default async function CaseTrackPage({ params }) {
  ...
  if (!c) {
    return (
      <div className="max-w-xl mx-auto text-center py-16">
        ...
        <Link href="/complaint" className="text-orange hover:underline text-base">{t('track.notFoundBackLink')}</Link>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-xl mx-auto">
      <Link href="/complaint" className="text-orange hover:underline mb-6 block text-base">{t('track.backLink')}</Link>
