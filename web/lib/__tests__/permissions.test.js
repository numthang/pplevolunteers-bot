...
describe('manageBasket (ทีมสื่อ editor + admin)', () => {
  ...
  it('ทีมบรรณาธิการ',    () => expect(allows('manageBasket', ['ทีมบรรณาธิการ'])).toBe(true))
  it('Moderator ไม่ได้', () => expect(allows('manageBasket', ['Moderator'])).toBe(false))
  it('ไม่มียศ ไม่ได้',   () => expect(allows('manageBasket', [])).toBe(false))
})
