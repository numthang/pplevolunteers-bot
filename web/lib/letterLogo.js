...
/** EMU — หน่วยของ docx · 914400 EMU = 1 นิ้ว, 360000 EMU = 1 ซม. · สูง 1008000 = 2.8 ซม.
 *  (เดิม 800100 ≈ 2.22 ซม. → ขยับเป็น 3.5 ซม. → user ขอเล็กลง 20% เหลือ 2.8 ซม. 2026-09-01) */
export const LOGO_BOX_H_EMU = 1008000
export const LOGO_BOX_W_EMU = 1163551
