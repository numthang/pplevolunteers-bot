...
export default function SplitModal({ isOpen, unassignedCount, onClose, onConfirm }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
      <div className="bg-white dark:bg-disc-hover rounded-lg shadow-lg max-w-md w-full max-h-[90vh] flex flex-col">
        <div className="flex items-center justify-between p-6 border-b border-warm-200 dark:border-disc-border shrink-0">
        ...
        <div className="flex gap-3 px-6 py-4 border-t border-warm-200 dark:border-disc-border shrink-0">
          <button
