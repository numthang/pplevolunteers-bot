    ...
    <div className="relative shrink-0 flex items-center" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-full mt-1.5 z-30 w-72 rounded-xl border border-warm-200 dark:border-disc-border bg-white dark:bg-card-bg shadow-lg py-1.5">
          ...
          {/* ตั้งค่าบอท — เข้าจากที่เดียวกับตั้งค่าองค์กร (2026-08-09) เพราะ /bot เป็น settings
              ไม่ใช่แอป · ต่างกันที่ scope: org vs เซิร์ฟเวอร์ Discord ที่เลือกอยู่ */}
          <a href="/bot" onClick={() => setOpen(false)} className={actionCls}>
            <IconBox d="M12 8V4H8M4 8h16v12H4zM2 14h2M20 14h2M15 13v2M9 13v2" />
            <span>ตั้งค่าบอท</span>
          </a>
          <a href="/profile/settings" onClick={() => setOpen(false)} className={actionCls}>
