...
// ลอกโครงจาก components/org/OrgSettingsNav.jsx — desktop = sidebar · mobile = dropdown overlay
// (ไม่ดันเนื้อหาลง เมนูโตได้ไม่จำกัด) · แก้ตัวไหนควรดูอีกตัวด้วยให้หน้าตาไม่หลุดกัน
const TAB_HREFS = [
  { href: '/profile/settings', key: 'account' },
  { href: '/profile/settings/brand', key: 'brand' },
]
