...
- handoff เอาไว้ทำไรนะ ล่าสุดผมไปทดลองใช้บน mac แล้ว clear ก็เริ่มคำสั่ง handoff ใน session ใหม่ได้เลย มันใช้ยังไง ก่อนผมจะเริ่ม session ใหม่ ต้องสั่งอะไรพิเศษไหม
