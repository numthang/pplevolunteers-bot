...
- cases ถ้ากดถอนตัวผู้รับผิดชอบ ไม่ว่าจะจาก kanban หรือ cases ส่วนนี้ไม่ sync กัน ตอนนี้มัน sync อะไรกันบ้างอ่ะ
- cases ยังไม่มีลบถาวร หรือ เก็บเข้ากรุ ส่วนลบนี้ ควร sync กับ kanban ไหม ถ้าเราลบจากที่ใดที่หนึ่ง ไม่ว่าจะระบบ cases หรือ posts เหมือนเคยถามไว้แล้ว ขอเหตุผลอีกที
...
/post ส่วนตัวมีแล้วไม่ใช่เหรอ นี่ไง http://localhost:3000/posts?filter=personal นี่ไง และ กำลังทำ http://localhost:3000/posts?status=draft

เรื่องร้องเรียน
รอทำ เคสทั้งหมดที่ยังไม่เปิด
กำลังทำ เคสที่ตัวเองรับผิดชอบ
