...
การบ้าน
รอทำ {การบ้านที่ยังไม่มีเจ้าภาพ}
กำลังทำ {การบ้านที่ตัวเองรับผิดชอบ}/{การบ้านทั้งหมดที่มีคนรับผิดชอบ}
เสร็จสิ้น {การบ้านที่เสร็จแล้ว}

* ผู้รับผิดชอบ นับทั้งที่เราเป็นเจ้าภาพหรือผู้ช่วย

เรื่องร้องเรียน
รอทำ {เคสที่ยังไม่มีเจ้าภาพ}
กำลังทำ {เคสที่ตัวเองรับผิดชอบ}/{เคสทั้งหมดที่มีคนรับผิดชอบ}
เสร็จสิ้น {เคสที่ปิดแล้ว}

* ผู้รับผิดชอบ นับทั้งที่เราเป็นเจ้าภาพหรือผู้ช่วย

งานสื่อ
รอทำ {สื่อส่วนตัว}/{สื่อองค์กร}
รอตรวจ
เสร็จสิ้น {สื่อที่โพสต์แล้ว}
