...
จริงๆ ผมอยากให้มองยังงี้ สำหรับ kanban มันมี เจ้าภาพ ซึ่งก็คือ owner_user_id ถูกใช่ไหม 
และ helpers มองเป็น ผู้รับผิดชอบ cases
create_by กับ owner_user_id ต่างกันไงนะ created_by คือ เจ้าภาพใช่ไหม
- kanban posts cases ตอนนี้ created_by แก้ไขไม่ได้ถูกไหม แต่อยากให้แสดงไว้หน่อย ไม่ต้องเด่น อย่ารก ui

อาสาส้ม ไม่ได้มีปัญหาในตัวมันเอง แต่เสียงสะท้อน มันเหมือนกับจะตั้งกลุ่มใหม่ขึ้นมา เอาเข้าจริง มันคืองานที่ไม่ได้แตกต่างจากงานเครือข่ายจังหวัด ใครจะดูแล คนทำงานส่วนใหญ่ก็อยู่ในเครือข่าย ปัญหาตอนนี้คือมันไม่มีคนประสานงานให้เกิดเครือข่ายทุกระดับ หรือจะแกนอะไรก็แล้วแต่ อาสาขึ้นกับผู้ปฏิบัติงานในพื้นที่ ซึ่งยอมรับว่าทีมจังหวัดก็ไม่ได้แข็งแรง 
การจะให้คนทำงานอะไรให้ไม่ใช่เพียงแค่แจกจ่าย แต่ต้องมีคนประสานงานพื้นที่จริงๆ หรือก็ที่เรียกว่าแกนนั่นแหละ แล้วปัญหาคือทำยังไงให้คนเขามาเป็นแกนให้เราล่ะ
