...
- ตอนนี้ระบบ docs sign url คนจะเซ็นต้อง login ไหมนะ ตอนนี้ผมประสบปัญหาส่งลิงก์ให้คน 20 คน เซ็นแล้ว ต้องมา login by discord มันก็กลายเป็นยุ่งยากกว่าเดิม อยากให้อารมณ์เหมือนผม ส่งลิงก์ (ส่งกระดาษ) ให้เซ็น ไม่ต้องมาดูว่าใครกันแน่ที่เซ็นอ่ะ
