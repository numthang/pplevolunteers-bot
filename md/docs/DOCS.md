...
| เย็น | ✅ | (ไม่ค้างคืน) กิจกรรมต้องจบไม่เร็วกว่า 20:00 |
| ว่างสาย | ✅ | ตามช่วงพักตอนเช้า |
| ว่างบ่าย | ✅ | ตามช่วงพักตอนบ่าย |

ตัวอย่าง: เริ่ม 13:00 เลิก 18:00 → เบิกได้แค่อาหารว่าง **ไม่มีกลางวัน ไม่มีเย็น** (ไม่ถึง 20:00)
...
- **มื้อหลักดูจากเวลาล้วน** — ครอบคลุมเที่ยง + จบ ≥ 20:00 → ได้ทั้งกลางวัน + เย็น (2 มื้อหลัก)
