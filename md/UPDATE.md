...
DELETE FROM `finance_transactions` WHERE account_id = 11
---
## 📞 PPLE Calling
### อัพเดท Calling (calling/pending)

### อัพเดท Calling (calling/[campaignId])
- เอาคอลัมน์ อำเภอ ในตารางออก ซ้ำซ้อนกับที่แสดงอยู่ใต้ชื่อสมาชิก ให้เปลี่ยนเป็น district แทน 
- อยากให้เรียงลำดับด้วยการกด sort ที่หัวตารางได้ เช่น ตำบล ชื่อ ระดับ 
- แสดงยังไงก็ได้ให้รู้ว่ากำลังหมดอายุ แต่จริงๆ ควรมี filter ว่าสมาชิกหมดอายุ ผมไม่แน่ใจว่าส่วนของ manage member นี่เราควรทำหน้าแยกไปอีกไหม หน้านี้ชักจะเลอะเทอะไปละ แต่ตอนนี้ผมก็ต้องการแค่นี้ แสดง icon อะไรสักอย่างได้ กับกรณีถ้าลาออกจากสมาชิกแล้ว ไม่รู้มีบอกใน ngs_member ไหม จะได้ไม่โทร หรือถ้าจะโทรก็จะได้ถามเหตุผลต่อได้ เผื่ออยากรู้ว่าเขาลาออกทำไม ขอคำปรึกษา ตรงนี้หน่อย
