...
- calling_campaigns นี่เรามาทำเป็นตาราง act_events ที่อยู่บนระบบ act เดิม เดี๋ยวผมถามขอข้อมูล schema มาให้ ปรึกษา gemini บอกให้ทำ cache act_events แล้วตัด calling_campaigns ทิ้ง ใช้ act_id แทน campaign_id อันนี้โอเคไหม
