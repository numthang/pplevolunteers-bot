...
- **prod: ต้องรัน migration `created_via` CHECK ก่อนขึ้นโค้ด** ไม่งั้นสคริปต์พังตอน INSERT
- เพิ่ม forum เลือกตั้ง (169 ใบ) ลง `FORUMS` แล้วรัน
- ~10% ของกระทู้หาเจ้าของไม่เจอ → ข้ามไป (แก้ได้ด้วย `--owner <discordId>` ถ้าอยากเก็บครบ)
  **ยอดจริงต่ำกว่าที่กลัวมาก: 1 ใบจาก 260**
