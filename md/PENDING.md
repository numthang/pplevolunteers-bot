...
### ⛔ ต้องเคาะก่อน cutover — guild "ทีมภูมิภาค" ไม่ได้แมปยศไว้เลย
...
**ห้ามแมปทั้งก้อนด้วยชื่อ** — จะได้ `Admin` 6 คนกลับมาด้วย ซึ่งเคาะแล้วว่าไม่เอา
→ ต้องแมปทีละยศตามเจตนาเจ้าของระบบ (แมป `ผู้ประสานงานจังหวัด`/`ผู้ประสานงานภาค`/`treasurer`/`moderator` · ไม่แมป `Admin`) แล้วยิง re-sync ทั้ง guild
