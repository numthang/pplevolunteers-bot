...
- [x] **🎨 การ์ดคำคมแบบไม่มีรูป (พื้นสี CI) — ✅ เสร็จ + verify 2026-08-10** (local · ยังไม่ deploy) · รายละเอียด `md/posts/POSTS.md` §🎨 การ์ดคำคมแบบไม่มีรูป
  ...
  - รอบแต่ง 2026-08-11: ลายพื้นมุมล่างขวา **สีจริง opacity 10% ทั้งดวงไม่โดนขอบตัด** · `plain-mark` สุ่มลายทุกใบ · ข้อความขยับขึ้นเว้นก้นการ์ด 16% ไว้แปะโลโก้ · เลือก **ฟอนต์ (อนาคตใหม่/Google Sans/สารบรรณ) + ขนาด (เล็ก/กลาง/ใหญ่)** ได้ในโมดัล
