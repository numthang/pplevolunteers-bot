...
- **verify:** timezone ผ่านทุกเคสภายใต้ `TZ=UTC` (8:30 ไทย → slot `-08` · เที่ยงคืน → null) · e2e ด้วย fake Discord client: รอบแรกส่ง 10/36 (cap ทำงาน) จำครบ 36 แถว · **รอบสองส่ง 0 = ไม่ซ้ำ** · embed 3,872 ตัวอักษร ไม่ทะลุ 4096
