...
- [ ] **ก้อน 4c — ยุบตะกร้าดิสฯ เข้า `post_episodes`** (user เคาะ 2026-07-29: "ระบบเดียว จัดการง่าย debug ง่าย")
  - รายละเอียด + 6 จุดที่ต้องระวังอยู่ `md/posts/PLAN-4.md` §เคาะแล้ว · **`dc_basket_slots`** (PK=channel_id · เปลี่ยนชื่อจาก `post_basket_slots` เคาะ 2026-07-30 — เป็น Discord artifact จึงคง `dc_`) · ล้างตะกร้า=archive · หมวด=ชื่อห้อง · รูปโหลดลงดิสก์ (ปิดบั๊กรูปหาย 24 ชม.) · `org_id` NULL = โผล่แค่ในดิสฯ
