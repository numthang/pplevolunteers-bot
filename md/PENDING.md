...
## 🧺 "งานยังไม่มีคนรับ" ไม่ควรเป็นของทุกคน — รากของเจ้าภาพปลอม (เจอ 2026-09-03 · ยังไม่ทำ)
...
**ทางแก้ที่ควรเป็น:** แยก "ยังไม่มีคนรับ" เป็น**กองของตัวเอง**ที่เห็นได้ชัด (ไม่ใช่ยัดเข้า "ของฉัน"
ของทุกคน) แล้ว "ไม่มีเจ้าภาพ" จะเลิกแพง → เคส/โพสต์นั่งรอคนรับได้อย่างซื่อสัตย์ และแท่ง lifecycle
ที่แก้ไป 2026-09-03 (ไม่มีคนรับ = แท่งว่าง) ถึงจะสื่อความจริงได้เต็มที่
⚠️ ทำก่อนงานอื่นที่จะทำให้การ์ดไม่มีเจ้าภาพเพิ่มขึ้นทีละเยอะๆ เสมอ

## 👥 Posts — ผู้รับผิดชอบหลายคน ให้ consistent กับ cases (user สั่ง 2026-09-03 · วางแพลนไว้ ยังไม่ทำ)
