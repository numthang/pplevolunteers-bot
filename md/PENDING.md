...
- [x] **🎨 การ์ดคำคมแบบไม่มีรูป (พื้นสี CI) — ✅ เสร็จ + verify 2026-08-10** (local · ยังไม่ deploy) · รายละเอียด `md/posts/POSTS.md` §🎨 การ์ดคำคมแบบไม่มีรูป
  ...
  - รอบแต่ง 2026-08-11 (รอบ 2): **color picker เลือกสีการ์ดเองได้ทั้ง 2 โหมด** ตั้งต้นที่สี CI + ปุ่มกลับไปสี CI · ครอปตั้งต้นเป็น **4:5** · "การลงสี"→**ธีม** · "สี"→**ฟิลเตอร์** (เป็น dropdown แล้ว รองรับเพิ่มฟิลเตอร์ในอนาคต)
