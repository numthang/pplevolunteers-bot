...
11. ✅ **แทนที่ name-check ด้วย permission (เสร็จ 2026-06-14):** ทุก gate ฝั่ง web เช็ค **permission** (ผ่าน `can()` / `isAdmin(access)`) แทนชื่อ Discord role → guild ที่ตั้งชื่อ role ต่างทำงานถูก · **ยังไม่ deploy prod**
