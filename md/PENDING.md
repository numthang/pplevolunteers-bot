...
## 📥 Backfill ของเก่า — ⛔ **user สั่งไม่ทำแล้ว (2026-08-25)** เก็บของเก่าไว้ใน Discord ตามเดิม

สคริปต์เขียนเสร็จและเทสผ่านแล้ว **เก็บไว้เฉยๆ** เผื่อเปลี่ยนใจ — ห้ามหยิบมารันเองโดยไม่ถาม
เหตุผลที่พับ: เครดิต AI หมดทั้ง 2 provider + user ตัดสินใจว่าเอาของปัจจุบันสำคัญกว่า
(ข้อมูลอ้างอิงถ้ารื้อมาทำใหม่: ย้อนหลัง 1 ปี = 142 กระทู้ ≈ 611,000 ตัวอักษร ≈ $1.55 ที่ Haiku 4.5)
