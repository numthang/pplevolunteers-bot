...
1. ⛔ **ไม่ backfill `post_assignees` จากคนสร้าง** — นั่นคือโรคที่งานนี้มาแก้ · ของเก่ากลายเป็น
   "ยังไม่มีคนรับ" อย่างซื่อสัตย์ (ไม่แพงแล้วเพราะเฟส A) · migration ยกเฉพาะคนที่**กดรับบนบอร์ดจริง**
   (user_id ≠ created_by · dev clone ของ prod = 1 แถวจาก 969) ที่เหลือ 968 แถวลบทิ้ง
