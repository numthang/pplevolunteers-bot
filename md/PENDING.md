...
### ⛔ ต้องอุด 2 อย่างนี้ก่อนเปิด `BOARDS_UI` กลับมา (พบ 2026-08-24 ตอน user ถามว่าสิทธิ์บอร์ดทำงานยังไง)
...
⚠️ ระวัง CHECK `kanban_cards_owner_required` (ไม่มีเจ้าภาพ = ต้องเป็น backlog/cancelled เท่านั้น · bug-160)
