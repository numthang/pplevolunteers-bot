...
## 👥 Posts — ผู้รับผิดชอบหลายคน ให้ consistent กับ cases (= **เฟส C** · ยังไม่ทำ)

📄 **แพลนตัวจริงอยู่ที่ `/home/tee/.claude/plans/owner-user-id-wild-hinton.md` §เฟส C**
(kanban ทำเสร็จแล้วเป็นเฟส B — ข้างล่างนี้คือบันทึกตอนสำรวจ เก็บไว้เป็นที่มา)
