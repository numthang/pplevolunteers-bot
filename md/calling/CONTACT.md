...
2. ประเภท `category` — grouped dropdown (ใช้ `<optgroup>`):
   - **กลุ่มคน:** ผู้บริจาค / คนสนใจ / อาสาสมัคร / แกนนำ / ผู้นำชุมชน / ประชาสังคม / สื่อมวลชน / นักการเมือง/อปท.
   - **ผู้ให้บริการ:** สถานที่ / งานพิมพ์/ป้าย / บริการอีเวนต์
   - **อื่นๆ:** อื่นๆ
