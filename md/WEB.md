...
- **1 กลุ่ม = 1 เซิร์ฟ = 1 ห้อง** · ตั้งที่ `/org/settings/social` → ปุ่ม **`+ Discord News`** (แถวเดียวกับปุ่ม Connect ทั้งโซนองค์กรและโซนส่วนตัว) → modal เลือกกลุ่ม + ห้อง · ใต้แถวปุ่มมีป้ายบอก กลุ่ม→ห้อง + ปุ่มถอด
