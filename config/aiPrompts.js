...
//
// ⚠️ ไฟล์นี้สร้างโดยการ **สกัดข้อความเดิมออกจาก route แบบ verbatim** ไม่ได้พิมพ์ใหม่
//    แก้ prompt ที่นี่ = เปลี่ยนค่าตั้งต้นของทุก org ที่ยังไม่เคยแก้ทับ
//
// สายการอ่าน (db/aiPrompts.js ฝั่งบอท · web/db/orgAiPrompts.js ฝั่งเว็บ):
//    แถวของ org (org_ai_prompts.org_id = <org>)  →  แถวกลาง (org_id IS NULL)  →  ค่าในไฟล์นี้
//    ไม่มีแถวใน DB = ใช้ค่าที่นี่ · DB ล่ม = ใช้ค่าที่นี่ (AI ต้องไม่พังเพราะ config)
//
// `requiredKeys` = ชื่อคีย์ที่ route ไปอ่านจาก JSON ที่ AI ตอบกลับมา
//    ตอนเซฟจาก backoffice ต้องเช็คว่า prompt ที่ผู้ใช้แก้ยังพูดถึงคีย์พวกนี้ครบ
//    ไม่งั้นผู้ใช้ลบบรรทัด "รูปแบบ JSON: {...}" ทิ้งแล้ว route พังทั้งเส้นโดยไม่รู้ว่าเพราะอะไร
//    (array ว่าง = prompt นี้คืนข้อความล้วน ไม่ใช่ JSON — แก้ได้อิสระ)
...
const AI_PROMPTS = [
  {
    ...
    prompt: `คุณเป็นผู้ช่วยบรรณาธิการงานสื่อของพรรคการเมืองไทย
...
- ตอบเป็นเนื้อหาโพสต์ล้วนๆ ห้ามมีหัวข้อ/คำอธิบาย/markdown ครอบ`,
  },
  {
    ...
    prompt: `คุณเป็นครีเอทีฟงานสื่อของพรรคการเมืองไทย
...
รูปแบบ JSON: {"quotes":["...","...","..."],"headlines":["...","...","..."],"imageIdeas":["...","...","..."],"hashtags":["...","..."],"cta":["..."],"articleTips":["..."]}`,
  },
  {
    ...
    surface: 'posts',
    requiredKeys: [],
    prompt: `คุณเป็นบรรณาธิการภาษาไทยของทีมสื่อพรรคการเมือง
...
- ตอบเป็นเนื้อหาโพสต์ล้วนๆ ห้ามมีคำอธิบาย/หัวข้อ/markdown ครอบ`,
  },
  {
    ...
    prompt: `คุณเป็นบรรณาธิการอาวุโสที่ตรวจเนื้อหาก่อนเผยแพร่ ให้เพจทางการของพรรคการเมืองไทย
...
รูปแบบ JSON: {"risks":[{"category":"defamation","severity":"high","excerpt":"ข้อความที่คัดจากต้นฉบับ","reason":"...","suggestion":"..."}]}`,
  },
  {
    ...
    prompt: `คุณช่วยร่างหนังสือร้องเรียนทางราชการภาษาไทยสำหรับทีมงานพรรคการเมือง
...
- body ขึ้นต้นด้วย "ด้วย..." หรือ "ตามที่..." และลงท้ายด้วย "จึงเรียนมาเพื่อโปรดพิจารณา"`,
  },
  {
    ...
    prompt: `วิเคราะห์บทสนทนา Discord แล้วสกัด event สำคัญออกมาเป็น timeline เรื่องร้องเรียน
...
/** ค่าตั้งต้นของช่องนี้ — null ถ้าไม่รู้จัก */
function defaultPrompt(value) {
  return bySlot.get(value) || null;
}

module.exports = { AI_PROMPTS, defaultPrompt };
