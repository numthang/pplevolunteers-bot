PENDING
- อันไหนไม่มีข้อมูลใส่ - เช่น หมู่ที่ ซอย ถนน 
- ข้าพเจ้าขอรับรองว่าได้รับเงินจากพรรค/สาขาพรรค {{ประชาชน}} ลำดับที่ xx ประจำจังหวัด {{province}} 
- ตอนนี้ต่อให้เอกสารไหนยังไม่มีการเซ็น ก็ให้แสดงในหน้า พิมพ์ได้เลย
- ลิงก์พิมพ์เอกสาร ใช้ role permission ตามลำดับชั้นของโครงการตามภูมิภาคและเหรัญญิก district_coordinator province_coordinator regional_coordinator secretary_general treasurer
- ลิงก์พิมพ์เอกสารมีสำเนาบัตร ปลอดภัยแค่ไหน
- font ที่เป็นตัว placeholder ขอสีปากกาเหมือนลายเซ็นอ่ะ หรือจะต่างกันนิดหน่อยก็ได้
- เอกสารแต่ละตัวที่เขียนว่า pdf เขียนว่า พิมพ์ ก็ได้
- title บน tile windows หน้า http://localhost:3000/api/docs/projects/1/export ตอนนี้เขียนว่า export ให้เขียนว่า เอกสารเคลียร์โครงการ {{โครงการย่อย}}
- คำว่า ร่าง หลัง ชื่อโครงการ หน้า http://localhost:3000/docs/117 คืออะไร
- เอกสารแต่ละใบ อยากให้แก้ไขคนรับเงินได้ด้วย อันนี้ยากซับซ้อนไหม เพราะต้องเพิ่ม search bar และ init value
- บน production https://pplevolunteers.org/api/docs/sign/preview?token=4afa8cb1-6370-4326-9e6e-3a2fc469cc67 ขึ้น {"error":"LibreOffice failed: unknown"}

- ว่าด้วยเรื่อง UX ผมว่าตอนนี้ยังมีการใช้ยาก สับสน สำหรับ user ทั้งสองฝั่ง อย่างน้อยควรมีเช่น  user เปิดมาแล้ว รู้ว่าควรจะกดเซ็นอะไรบ้าง
