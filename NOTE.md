PENDING
ไม่รู้ตรง ค้นหา ชื่อสมาชิกอ่ะ มันทำได้ไหม ให้แสดงชื่อ recently member ก่อน โดยที่ไม่ต้องพิมพ์
กิจกรรม 7 มิ.ย. 2569 07:00 น. – 7 มิ.ย. 2569 13:00 น. ไม่ควรได้ ค่าอาหารว่าง (2 มื้อ) เพราะ ไม่คร่อมบ่ายสามโมงเลย อันนี้ผม ตั้งกฏเอาเอง เพราะงานไม่จบบ่าย

เจอ bug อีกตัว กรณีงานมีแต่เวลาเริ่ม ไม่มีเวลาจบ ทำให้การคำนวณใบสำคัญมีปัญหาได้
เกิดข้อผิดพลาด: Item type "sound" not allowed for this project หมายความว่าไงน่ะ
