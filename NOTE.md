PENDING
- ทำให้ชื่อยศเริ่มต้นมัน ชื่อมันเป็นกลางๆ กว่านี้ ตอนนี้เป็นแบบองค์กรพรรคการเมือง ไปหน่อย 
- interest/skill role เช่นเดียวกัน ของตัวอย่าง ใช้ชื่อกลางๆ ที่ทุกองค์กรมักจะมี รวมๆ ไม่เกิน อย่างละ 5 ตัวพอ ตัด role เฉพาะแบบพรรคการเมืองออกไป
- ทั้งหมดส่งชื่อมาให้ผมรีวิวก่อน
- ทีนี้ ก่อนจะรันซ้ำ อยากให้มีลบ role เดิมๆ ออกไปทั้งหมดแล้วทำ role ใหม่จะติดปัญหาอะไรไหม


- เพิ่มเปิดปิด finance ใน feature ด้วย
