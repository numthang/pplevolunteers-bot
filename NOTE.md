...
🧡 สวัสดีครับ/ค่ะ ยินดีต้อนรับทุกท่าน เพื่อความปลอดภัยกรุณาทำตามขั้นตอน 2 ขั้นนี้ (ยังไม่ต้องพิมพ์แนะนำตัวห้องนี้ กดปุ่มเขียว 🟩 verify ก่อน!)

ขั้นที่ 1: กดที่ข้อความ >> ⁠✅┆welcome⁠ และ กดคำว่า “verify” แล้วเลื่อนมาด้านล่างสุด กดตัวเลขที่เห็นทีละตัวและกดตกลง บนแป้นตัวเลข เพื่อยืนยันว่าไม่ใช่บอท (คือไม่ใช่โปรแกรมหุ่นยนต์ที่มาโจมตีเซิร์ฟเวอร์)

ขั้นที่ 2: จะมีห้องให้พิมพ์แนะนำตัวขึ้นมาให้เห็นเพื่อไปต่อ หรือกดได้ที่ >> ⁠⭐┆ห้องพิมพ์แนะนำตัว แล้วรอเพื่อให้แอดมินแจกยศให้เห็นห้องของตนเองต่อไป
