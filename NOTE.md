...
- backfill กระทู้สื่อ ของเก่าๆ ย้อนหลัง 1 ปี เข้า posts และ เชื่อม kanban ด้วย แต่ไม่ต้องมาทับของใหม่ๆ ตอนนีี้นะ ทำได้ไหม ขอดู dry-run ก่อนก็ได้ ว่าจะนำเข้าอะไรได้บ้าง
- http://localhost:3000/kanban ตอนนี้ limit กี่ใบต่อ column ทำให้กด load เพิ่มได้ไหม
- เพิ่มสายงาน ประสานงาน ลงไปด้วย เช่น ชวนคนไปเข้าร่วมกิจกรรม กิจกรรมก็ต้องมี badge ประสานงาน ด้วย
