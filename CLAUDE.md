...
- **Verify แบบถูก:** build + curl พอ · Opus อ่านเฉพาะ logic เสี่ยง ไม่อ่านทั้งไฟล์
- **spec เป๊ะ = ตัวประหยัดจริง** (agent flail = เผา token) · ตัวประหยัดหลัก = tier model ลงตามงาน ไม่ใช่ซ้อน agent เยอะๆ
